...
class AdminService:
	...
	async def update_user(self, user_id: int, payload: UserUpdateSchema) -> AdminUserResponseSchema:
		"""
		...
		return AdminUserResponseSchema.model_validate(await self.user_repo.get_by_id(user_id))
	...
	async def delete_user(self, user_id: int) -> dict:
		...
		await self.user_repo.session.commit()
		return {"status": "success", "detail": f"User {user_id} has been successfully deleted"}
